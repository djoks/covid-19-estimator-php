...
function covid19ImpactEstimator($data)
{
  ...
  $impact->hospitalBedsByRequestedTime = floor(($data["totalHospitalBeds"] * PERCENTAGE_HOSPITAL_BED_AVAILABLITY) - $impact->severeCasesByRequestedTime);
  ...
  $severeImpact->hospitalBedsByRequestedTime = floor(($data["totalHospitalBeds"] * PERCENTAGE_HOSPITAL_BED_AVAILABLITY) - $severeImpact->severeCasesByRequestedTime);
